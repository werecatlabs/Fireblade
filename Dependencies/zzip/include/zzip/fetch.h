...
#define zzip_file_header_sizeof_tails( __p ) \
    ( zzip_file_header_get_namlen( __p ) + zzip_file_header_get_extras( __p ) )
...
/* zzip_file_header - the local file header */
#define zzip_file_header_csize( __p ) ( (zzip_size_t)zzip_file_header_get_csize( __p ) )
#define zzip_file_header_usize( __p ) ( (zzip_size_t)zzip_file_header_get_usize( __p ) )
#define zzip_file_header_namlen( __p ) ( (zzip_size_t)zzip_file_header_get_namlen( __p ) )
#define zzip_file_header_extras( __p ) ( (zzip_size_t)zzip_file_header_get_extras( __p ) )
#define zzip_file_header_sizeof_tail( __p ) ( (zzip_size_t)zzip_file_header_sizeof_tails( __p ) )
#define zzip_file_header_sizeto_end( __p ) \
    ( (zzip_size_t)( zzip_file_header_sizeof_tail( __p ) + zzip_file_header_headerlength ) )
#define zzip_file_header_skipto_end( __p ) \
    ( (void *)( __p ) + ( zzip_file_header_sizeof_tail( __p ) + zzip_file_header_headerlength ) )

#define zzip_file_header_to_filename( __p ) \
    ( (char *)( (char *)( __p ) + zzip_file_header_headerlength ) )
...
#define zzip_file_header_to_trailer( __p ) \
    ( (struct zzip_file_trailer *)( zzip_file_header_to_data( __p ) + zzip_file_header_csize( __p ) ) )

/* zzip_file_trailer - data descriptor per file block */
#define zzip_file_trailer_csize( __p ) ( (zzip_size_t)zzip_file_trailer_get_csize( __p ) )
#define zzip_file_trailer_usize( __p ) ( (zzip_size_t)zzip_file_trailer_get_usize( __p ) )
#define zzip_file_trailer_sizeof_tail( __p ) ( (zzip_size_t)zzip_file_trailer_sizeof_tails( __p ) )
#define zzip_file_trailer_sizeto_end( __p ) \
    ( (zzip_size_t)( zzip_file_trailer_sizeof_tail( __p ) + zzip_file_trailer_headerlength ) )
#define zzip_file_trailer_skipto_end( __p ) \
    ( (void *)( __p ) + ( zzip_file_trailer_sizeof_tail( __p ) + zzip_file_trailer_headerlength ) )

/* zzip_disk_entry (currently named zzip_root_dirent) */
#define zzip_disk_entry_csize( __p ) ( (zzip_size_t)zzip_disk_entry_get_csize( __p ) )
#define zzip_disk_entry_usize( __p ) ( (zzip_size_t)zzip_disk_entry_get_usize( __p ) )
#define zzip_disk_entry_namlen( __p ) ( (zzip_size_t)zzip_disk_entry_get_namlen( __p ) )
#define zzip_disk_entry_extras( __p ) ( (zzip_size_t)zzip_disk_entry_get_extras( __p ) )
#define zzip_disk_entry_comment( __p ) ( (zzip_size_t)zzip_disk_entry_get_comment( __p ) )
#define zzip_disk_entry_diskstart( __p ) ( (int)zzip_disk_entry_get_diskstart( __p ) )
#define zzip_disk_entry_filetype( __p ) ( (int)zzip_disk_entry_get_filetype( __p ) )
#define zzip_disk_entry_filemode( __p ) ( (int)zzip_disk_entry_get_filemode( __p ) )
#define zzip_disk_entry_fileoffset( __p ) ( (zzip_off_t)zzip_disk_entry_get_offset( __p ) )
#define zzip_disk_entry_sizeof_tail( __p ) ( (zzip_size_t)zzip_disk_entry_sizeof_tails( __p ) )
#define zzip_disk_entry_sizeto_end( __p ) \
    ( (zzip_size_t)( zzip_disk_entry_sizeof_tail( __p ) + zzip_disk_entry_headerlength ) )
#define zzip_disk_entry_skipto_end( __p ) \
    ( (zzip_byte_t *)( __p ) + ( zzip_disk_entry_sizeof_tail( __p ) + zzip_disk_entry_headerlength ) )
...
#define zzip_disk_entry_to_next_entry( __p ) \
    ( (struct zzip_disk_entry *)( zzip_disk_entry_to_comment( __p ) + zzip_disk_entry_comment( __p ) ) )

/* zzip_disk_trailer - the zip archive entry point */
#define zzip_disk_trailer_localdisk( __p ) ( (int)zzip_disk_trailer_get_disk( __p ) )
#define zzip_disk_trailer_finaldisk( __p ) ( (int)zzip_disk_trailer_get_finaldisk( __p ) )
#define zzip_disk_trailer_localentries( __p ) ( (int)zzip_disk_trailer_get_entries( __p ) )
#define zzip_disk_trailer_finalentries( __p ) ( (int)zzip_disk_trailer_get_finalentries( __p ) )
#define zzip_disk_trailer_rootsize( __p ) ( (zzip_off_t)zzip_disk_trailer_get_rootsize( __p ) )
#define zzip_disk_trailer_rootseek( __p ) ( (zzip_off_t)zzip_disk_trailer_get_rootseek( __p ) )
#define zzip_disk_trailer_comment( __p ) ( (zzip_size_t)zzip_disk_trailer_get_comment( __p ) )
#define zzip_disk_trailer_sizeof_tail( __p ) ( (zzip_size_t)zzip_disk_trailer_sizeof_tails( __p ) )
#define zzip_disk_trailer_sizeto_end( __p ) \
    ( (zzip_size_t)( zzip_disk_trailer_sizeof_tail( __p ) + zzip_disk_trailer_headerlength ) )
#define zzip_disk_trailer_skipto_end( __p ) \
    ( (void *)(__p)( zzip_disk_trailer_sizeof_tail( __p ) + zzip_disk_trailer_headerlength ) )

#define zzip_disk_trailer_to_comment( __p ) \
    ( (char *)( (char *)( __p ) + zzip_disk_trailer_headerlength ) )
...
#define zzip_disk64_trailer_localdisk( __p ) ( (int)zzip_disk64_trailer_get_disk( __p ) )
#define zzip_disk64_trailer_finaldisk( __p ) ( (int)zzip_disk64_trailer_get_finaldisk( __p ) )
#define zzip_disk64_trailer_localentries( __p ) ( (int)zzip_disk64_trailer_get_entries( __p ) )
#define zzip_disk64_trailer_finalentries( __p ) ( (int)zzip_disk64_trailer_get_finalentries( __p ) )
#define zzip_disk64_trailer_rootsize( __p ) ( (zzip_off64_t)zzip_disk64_trailer_get_rootsize( __p ) )
#define zzip_disk64_trailer_rootseek( __p ) ( (zzip_off64_t)zzip_disk64_trailer_get_rootseek( __p ) )
#define zzip_disk64_trailer_sizeof_tail( __p ) \
    ( (zzip_size_t)zzip_disk64_trailer_get_size( __p ) - zzip_disk64_trailer_headerlength )
#define zzip_disk64_trailer_sizeto_end( __p ) ( (zzip_size_t)zzip_disk64_trailer_get_size( __p ) )
#define zzip_disk64_trailer_skipto_end( __p ) \
    ( (void *)( (char *)( __p ) + zzip_disk64_sizeto_end( __p ) ) )

/* extra field should be type + size + data + type + size + data ... */
#define zzip_extra_block_sizeof_tail( __p ) ( (zzip_size_t)( zzip_extra_block_get_datasize( __p ) ) )
#define zzip_extra_block_sizeto_end( __p ) \
    ( (zzip_size_t)( zzip_extra_block_sizeof_tail( __p ) + zzip_extra_block_headerlength ) )
#define zzip_extra_block_skipto_end( __p ) \
    ( (void *)(__p)( zzip_extra_block_sizeof_tail( __p ) + zzip_extra_block_headerlength ) )

/* ................... and put these to the next level ................ */

#define zzip_file_header_data_encrypted( __p ) ZZIP_IS_ENCRYPTED( zzip_file_header_get_flags( __p ) )
#define zzip_file_header_data_comprlevel( __p ) ZZIP_IS_COMPRLEVEL( zzip_file_header_get_flags( __p ) )
#define zzip_file_header_data_streamed( __p ) ZZIP_IS_STREAMED( zzip_file_header_get_flags( __p ) )
#define zzip_file_header_data_stored( __p ) ( ZZIP_IS_STORED == zzip_file_header_get_compr( __p ) )
#define zzip_file_header_data_deflated( __p ) ( ZZIP_IS_DEFLATED == zzip_file_header_get_compr( __p ) )

#define zzip_disk_entry_data_encrypted( __p ) ZZIP_IS_ENCRYPTED( zzip_disk_entry_get_flags( __p ) )
#define zzip_disk_entry_data_comprlevel( __p ) ZZIP_IS_COMPRLEVEL( zzip_disk_entry_get_flags( __p ) )
#define zzip_disk_entry_data_streamed( __p ) ZZIP_IS_STREAMED( zzip_disk_entry_get_flags( __p ) )
#define zzip_disk_entry_data_stored( __p ) ( ZZIP_IS_STORED == zzip_disk_entry_get_compr( __p ) )
#define zzip_disk_entry_data_deflated( __p ) ( ZZIP_IS_DEFLATED == zzip_disk_entry_get_compr( __p ) )
#define zzip_disk_entry_data_ascii( __p ) ( zzip_disk_entry_get_filetype( __p ) & 1 )

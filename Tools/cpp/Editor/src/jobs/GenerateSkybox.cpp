                    ...
                    if( selected->isDerived<scene::IActor>() )
                    {
                        ...
                        if( auto skybox = actor->getComponent<scene::Skybox>() )
                        {
                            for( const auto &file : files )
                            {
                                ...
                                {
                                    skybox->setTextureByName(
                                        relativePath, (u32)render::IMaterial::SkyboxTextureTypes::Back );
                                }
                                ...
                                {
                                    skybox->setTextureByName(
                                        relativePath, (u32)render::IMaterial::SkyboxTextureTypes::Up );
                                }

                                if( fileNameLower.find( "down" ) != std::string::npos )
                                {
                                    skybox->setTextureByName(
                                        relativePath, (u32)render::IMaterial::SkyboxTextureTypes::Down );
                                }
                            }
                        }
                    }

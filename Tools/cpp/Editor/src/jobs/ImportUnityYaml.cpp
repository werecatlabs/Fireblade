...
namespace fb
{
    namespace editor
    {
        ...
        ImportUnityYaml::ImportUnityYaml()
        {
        }
                        ...
                        for( auto transform : transforms )
                        {
                            ...
                            if( gameObjectProperties )
                            {
                                ...
                                if( parentActor )
                                {
                                    ...
                                    {
                                        auto childrenProperties =
                                            child->getChildrenByName( "m_Children" );
                                        for( auto childProperties : childrenProperties )
                                        {
                                            ...
                                            if( !StringUtil::isNullOrEmpty( fileID ) )
                                            {
                                                auto actor =
                                                    resourceDatabase
                                                        ->getObjectTypeByFileId<scene::IActor>( fileID );
                                                if( actor )
                                                {
                                                ...
                                                auto transform =
                                                    resourceDatabase
                                                        ->getObjectTypeByFileId<scene::ITransform>(
                                                            fileID );
                                                if( transform )
                                                {

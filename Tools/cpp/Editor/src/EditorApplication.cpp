...
namespace fb
{
    namespace editor
    {
        ...
        IFSM::ReturnType EditorApplication::handleEvent( u32 state, IFSM::Event eventType )
        {
            switch( eventType )
            {
...
#    endif
        ...
        bool EditorApplication::createScriptManager()
        {
            auto applicationManager = core::IApplicationManager::instance();
            FB_ASSERT( applicationManager );
...
#    endif
        ...
        SmartPtr<render::ICamera> EditorApplication::getUiCamera() const
        {
            return m_uiCamera;
        }
        ...
        SmartPtr<render::ISceneNode> EditorApplication::getUiCameraSceneNode() const
        {
        ...
        SmartPtr<render::ICamera> EditorApplication::getCamera() const
        {
            return m_camera;
        }
        ...
        SmartPtr<render::ISceneNode> EditorApplication::getCameraSceneNode() const
        {
        ...
        SmartPtr<IStateContext> EditorApplication::getStateObject() const
        {
            return m_stateObject;
        }

        void EditorApplication::setStateObject( SmartPtr<IStateContext> stateObject )
        {
        ...
        EditorApplication::ApplicationInputListener::ApplicationInputListener( EditorApplication *app ) :
            m_application( app )
        {
        }

        EditorApplication::ApplicationInputListener::~ApplicationInputListener()
        {
        }

        Parameter EditorApplication::ApplicationInputListener::handleEvent(
        ...
        bool EditorApplication::ApplicationInputListener::inputEvent( SmartPtr<IInputEvent> event )
        {
            auto applicationManager = core::IApplicationManager::instance();
            FB_ASSERT( applicationManager );
        ...
        bool EditorApplication::ApplicationInputListener::updateEvent(
            const SmartPtr<IInputEvent> &event )
        {
            return false;
        }

        void EditorApplication::ApplicationInputListener::setPriority( s32 priority )
        {
        }

        s32 EditorApplication::ApplicationInputListener::getPriority() const
        {
            return 0;
        }
        ...
        IFSM::ReturnType EditorApplication::ApplicationFSMListener::handleEvent( u32 state,
        ...
        Parameter EditorApplication::EventListener::handleEvent(
            IEvent::Type eventType, hash_type eventValue, const Array<Parameter> &arguments,
            SmartPtr<ISharedObject> sender, SmartPtr<ISharedObject> object, SmartPtr<IEvent> event )
        {
            return Parameter();

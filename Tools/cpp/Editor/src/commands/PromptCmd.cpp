...
namespace fb::editor
{
    ...
    PromptCmd::PromptCmd()
    {
        ...
        goalEvaluators.emplace_back( fb::make_ptr<AddPromptEvaluator>(
        ...
        goalEvaluators.emplace_back( fb::make_ptr<RemovePromptEvaluator>(
    ...
    auto PromptCmd::getPrompt() const -> String
    {
        return m_prompt;
    }

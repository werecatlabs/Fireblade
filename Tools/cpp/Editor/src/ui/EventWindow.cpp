...
namespace fb::editor
{
    ...
    auto EventWindow::getEvent() const -> SmartPtr<scene::IComponentEvent>
    {
        return m_event;
    }
    ...
    auto EventWindow::UIElementListener::handleEvent( IEvent::Type eventType, hash_type eventValue,
    ...
    auto EventWindow::UIElementListener::getOwner() const -> EventWindow *
    {
        return m_owner;
    }

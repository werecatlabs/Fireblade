    ...
    namespace editor
    {
        ...
        void ActorWindow::load( SmartPtr<ISharedObject> data )
        {
            try
            {
                ...
                m_actorEnabled = ui->addElementByType<ui::IUILabelCheckboxPair>();
                m_actorVisible = ui->addElementByType<ui::IUILabelCheckboxPair>();
                m_actorStatic = ui->addElementByType<ui::IUILabelCheckboxPair>();
        ...
        void ActorWindow::addObjectToTree( SmartPtr<ISharedObject> object,
                                           SmartPtr<ui::IUITreeNode> node )
        {
            try
            {
        ...
        void ActorWindow::addResourceToTree( SmartPtr<IResource> resource,
                                             SmartPtr<ui::IUITreeNode> node )
        {
            // try
            //{
        ...
        ActorWindow *ActorWindow::UIElementListener::getOwner() const
        {
            return m_owner;
        }

...
namespace fb::editor
{
    ...
    auto MaterialWindow::getMaterial() const -> SmartPtr<render::IMaterial>
    {
        return m_material;
    }
    ...
    auto MaterialWindow::getTree() const -> SmartPtr<ui::IUITreeCtrl>
    {
        return m_tree;
    }
        ...
        try
        {
            ...
            if( currentScene )
            {
                ...
                if( selection.size() == 1 )
                {
                    ...
                    {
                        auto fileSelection = fb::dynamic_pointer_cast<FileSelection>( selectedObject );
    ...
    auto MaterialWindow::TreeCtrlListener::handleEvent( IEvent::Type eventType, hash_type eventValue,
    ...
    auto MaterialWindow::TreeCtrlListener::getOwner() const -> MaterialWindow *
    {
        return m_owner;
    }
    ...
    auto MaterialWindow::DropdownListener::handleEvent( IEvent::Type eventType, hash_type eventValue,
                                                        const Array<Parameter> &arguments,
                                                        SmartPtr<ISharedObject> sender,
                                                        SmartPtr<ISharedObject> object,
                                                        SmartPtr<IEvent> event ) -> Parameter
    ...
    auto MaterialWindow::DropdownListener::getOwner() const -> MaterialWindow *
    {
        return m_owner;
    }

...
namespace fb::editor
{
    ...
    auto TerrainWindow::getTerrainEditor() const -> SmartPtr<ui::IUITerrainEditor>
    {
    ...
    auto TerrainWindow::UIElementListener::handleEvent( IEvent::Type eventType, hash_type eventValue,
    ...
    auto TerrainWindow::UIElementListener::getOwner() const -> TerrainWindow *
    {
        return m_owner;
    }

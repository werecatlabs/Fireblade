...
namespace fb::editor
{
    ...
    auto ResourceWindow::TreeCtrlListener::handleEvent( IEvent::Type eventType, hash_type eventValue,
    ...
    auto ResourceWindow::TreeCtrlListener::getOwner() const -> ResourceWindow *
    {
        return m_owner;
    }

...
namespace fb
{
    namespace editor
    {
        ...
        */
        class BaseWindow : public SharedObject<scene::IEditor>
        {
        public:
            /*
             * @brief Constructor.
        ...
        protected:
            class UIListener : public SharedObject<IEventListener>
            {
            public:
                UIListener() = default;
                ...
                void setOwner( BaseWindow *owner );

            private:
                BaseWindow *m_owner = nullptr;
            };

            class UIDragSource : public SharedObject<ui::IUIDragSource>
            {
            public:
            ...
            class UIDropTarget : public SharedObject<ui::IUIDropTarget>
            {
            public:

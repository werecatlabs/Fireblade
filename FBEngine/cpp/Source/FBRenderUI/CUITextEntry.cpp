...
namespace fb::ui
{
    ...
    auto CUITextEntry::handleEvent( const SmartPtr<IInputEvent> &event ) -> bool
    {
    ...
    {
        auto timer = core::ApplicationManager::instance()->getTimer();
    ...
    auto CUITextEntry::getText() const -> String
    {
        return m_text;
    }
    ...
    auto CUITextEntry::getTextSize() const -> f32
    {
        return 0.0f;
    }
    ...
    void CUITextEntry::setVerticalAlignment( u8 alignment )
    {
        throw std::logic_error( "The method or operation is not implemented." );
    }

    u8 CUITextEntry::getVerticalAlignment() const
    {
        throw std::logic_error( "The method or operation is not implemented." );
    }

    void CUITextEntry::setHorizontalAlignment( u8 alignment )
    {
        throw std::logic_error( "The method or operation is not implemented." );
    }

    u8 CUITextEntry::getHorizontalAlignment() const
    {
        throw std::logic_error( "The method or operation is not implemented." );
    }

...
namespace fb
{
    namespace ui
    {
        ...
        void CUISpinner::initialise( SmartPtr<IUIElement> &parent, const TiXmlNode *pNode )
        {
            ...
            {
                m_minValue = 0.0;
                m_maxValue = (f64)( m_values.size() - 1 );
                // m_value = m_values.find_element_index(m_text);
            }
        }

        bool CUISpinner::handleEvent( const SmartPtr<IInputEvent> &event )
        {
            if( !isEnabled() )
                return false;
        ...
        String CUISpinner::getValue() const
        {
            return m_text;
        }
        ...
        String CUISpinner::getMinValue() const
        {
        ...
        String CUISpinner::getMaxValue() const
        {
        ...
        String CUISpinner::getText() const
        {
            return m_text;
        }

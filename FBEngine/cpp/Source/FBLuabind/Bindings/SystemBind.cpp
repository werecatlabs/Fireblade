...
namespace fb
{
    ...
    //
    //void _addStateListener( IStateObject *stateObject, StateListenerPtr stateListner )
    //{
    //    stateObject->addStateListener( stateListner );
    //}

    //
    //void _addStateListenerIsOwner( IStateObject *stateObject, StateListenerPtr stateListner,
    //                               bool isOwner )
    //{
    //    stateObject->addStateListener( stateListner, isOwner );
    //}
    ...
    //FSMPtr _getFSM( core::IApplicationManager *engine )
    //{
    ...
    void bindSystem( lua_State *L )
    {
        ...
        module( L )[class_<IResource, core::IPrototype, SmartPtr<IResource>>( "IResource" )
                        ...
                        .def( "getStateObject", &IResource::getStateObject )
                        .def( "setStateObject", &IResource::setStateObject )
        ...
        module(
            L )[class_<core::IApplicationManager, ISharedObject, SmartPtr<core::IApplicationManager>>(
                    "IApplicationManager" )
                    ...
                    .def( "getSettingsCachePath", &IApplicationManager::getSettingsCachePath )
                    .def( "setSettingsCachePath", &IApplicationManager::setSettingsCachePath )
                    ...
                    .def( "getPluginInterface", &IApplicationManager::getPluginInterface )
                    .def( "setPluginInterface", &IApplicationManager::setPluginInterface )
                    ...
                    .def( "getStateObject", &IApplicationManager::getStateObject )
                    .def( "setStateObject", &IApplicationManager::setStateObject )

...
#include "FBLuabind/Bindings/SceneBind.h"
        ...
        module(
            L )[class_<IActor, IResource, SmartPtr<ISharedObject>>( "IActor" )
                    ...
                    .def( "getLocalTransform",
                          ( Transform3<real_Num>( IActor::* )() const ) & IActor::getLocalTransform )
                    .def( "getWorldTransform",
                          ( Transform3<real_Num>( IActor::* )() const ) & IActor::getWorldTransform )
                    ...
                    .def( "getStateContext", &IActor::getStateContext )
                    .def( "setStateContext", &IActor::setStateContext )

...
namespace fb
{
    namespace physics
    {
        ...
        PhysxPoolAllocator::PhysxPoolAllocator( size_t poolSize, size_t alignment )
        ...
        void *PhysxPoolAllocator::allocate( size_t size, const char *typeName, const char *filename,
                                            int line )
        {
        ...
        void PhysxPoolAllocator::deallocate( void *ptr )
        {
            if( ptr )
            {
                ...
                mFreeBlocks.push_back( std::make_pair( offset, size ) );
                mPoolIndex = offset;

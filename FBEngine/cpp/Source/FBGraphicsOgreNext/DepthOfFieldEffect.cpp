...
namespace fb::render
{
    ...
    auto DepthOfFieldEffect::renderableQueued( Ogre::Renderable *rend, Ogre::uint8 groupID,
                                               Ogre::ushort priority, Ogre::Technique **ppTech,
                                               Ogre::RenderQueue * ) -> bool
    {
#if 0
    ...
    auto DepthOfFieldEffect::getFarBlurCutoff() const -> float
    {
        return mFarBlurCutoff;
    }

    auto DepthOfFieldEffect::getFarDepth() const -> float
    {
        return mFarDepth;
    }

    auto DepthOfFieldEffect::getFocalDepth() const -> float
    {
        return mFocalDepth;
    }

    auto DepthOfFieldEffect::getNearDepth() const -> float
    {
        return mNearDepth;
    }

    ...
    */
        ...
        m_useCodepoint0ForRaster( false )
    {
        ...
        if( errorCode )
        {
            ...
            errorMsg.clear();
            errorMsg.a( "[Freetype2 error] Could not open font ", fontLocation,
                        " errorCode: ", errorCode,
    ...
    //-------------------------------------------------------------------------
    bool Shaper::getUseCodepoint0ForRaster() const
    {
        return m_useCodepoint0ForRaster;
    }
    //-------------------------------------------------------------------------
                                 ...
                                 bool &bOutHasPrivateUse, bool substituteIfNotFound )
    {
        ...
        for( size_t i = 0; i < glyphCount; ++i )
        {
            ...
            if( i < glyphCount )
            {
                ...
                shapedGlyph.isWordBreaker = utf16Str[cluster] == L' ' || utf16Str[cluster] == L'\t' ||

...
namespace Colibri
{
        ...
        GridLocations::GridLocations gridLoc ) const
    {
        ...
        case GridLocations::TopLeft:
            return GridLocations::TopRight;
        case GridLocations::Top:
            return GridLocations::Top;
        case GridLocations::TopRight:
            return GridLocations::TopLeft;
        case GridLocations::CenterLeft:
            return GridLocations::CenterRight;
        case GridLocations::Center:
            return GridLocations::Center;
        case GridLocations::CenterRight:
            return GridLocations::CenterLeft;
        case GridLocations::BottomLeft:
            return GridLocations::BottomRight;
        case GridLocations::Bottom:
            return GridLocations::Bottom;
        case GridLocations::BottomRight:
            return GridLocations::BottomLeft;
        case GridLocations::NumGridLocations:
            return GridLocations::NumGridLocations;
        }
    ...
    ColibriManager::getDefaultSkin( SkinWidgetTypes::SkinWidgetTypes widgetType ) const
    {
    ...
    */
    ...
    //-------------------------------------------------------------------------
    void ColibriManager::_addDirtyLabelBmp( LabelBmp *label )
    {
        m_dirtyLabelBmps.push_back( label );
    }
    //-------------------------------------------------------------------------

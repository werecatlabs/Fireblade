...
namespace Colibri
{
    ...
    //-------------------------------------------------------------------------
    void LabelBmp::setFontSize( FontSize fontSize )
    {
        m_fontSize = fontSize;
    }
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    void LabelBmp::setTextColour( const Ogre::ColourValue &colour )
    {
        m_colour = colour;
    }
    //-------------------------------------------------------------------------
    ...
    //-------------------------------------------------------------------------
    void LabelBmp::_updateDirtyGlyphs()
    {
        updateGlyphs();
    }
    //-------------------------------------------------------------------------
    bool LabelBmp::isLabelBmpDirty() const
    {
        return m_glyphsDirty;
    }
    //-------------------------------------------------------------------------

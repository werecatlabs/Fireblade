...
namespace fb
{
    namespace render
    {
        ...
        s32 OgreUtil::calculateNearest2Pow( s32 input )
        {
            if( input <= 32 )
                return 32;
            if( input <= 64 )
        ...
        //--------------------------------------------
        Ogre::TerraTextureTypes OgreUtil::getTerrainTextureType(
        ...
        bool OgreUtil::loadIntoImage( const String &filePath, Ogre::Image2 &outImage )
        {
            try
            {

...
namespace fb
{
    namespace render
    {
        ...
        void CTextureOgreNext::load( SmartPtr<ISharedObject> data )
        {
            try
            {
                ...
                if( usageFlags == TU_RENDERTARGET )
                {
                    ...
                    {
                        auto pRenderTarget =
                            fb::static_pointer_cast<CRenderTargetOgreNext<IRenderTarget>>(
                                m_renderTarget );
                ...
                else
                {
                    ...
                    if( !StringUtil::isNullOrEmpty( textureName ) )
                    {
                        ...
                        texture->scheduleTransitionTo( Ogre::GpuResidency::GpuResidency::Resident,
                                                       imagePtr, true );
        ...
        Vector2I CTextureOgreNext::getSize() const
        {
            return m_size;
        }
        ...
        Vector2I CTextureOgreNext::getActualSize() const
        {
            return Vector2I::zero();
        }

        Ogre::TextureGpu *CTextureOgreNext::getTexture() const
        {
            return m_texture;
        }
        ...
        void CTextureOgreNext::createStateObject()
        {
            ...
            FB_ASSERT( getStateObject() == nullptr );
...
#elif defined FB_PLATFORM_APPLE
#    if FB_BUILD_RENDERER_METAL
                //auto texture = (Ogre::MetalTextureGpu *)ogreTexture;
                //auto tex = texture->getFinalTextureName();
                //*ppTexture = tex;
#    elif FB_BUILD_RENDERER_OPENGL
                auto texture = (Ogre::GL3PlusTextureGpu *)ogreTexture;
...
#    endif
        ...
        size_t CTextureOgreNext::getTextureHandle() const
        {
        ...
        u32 CTextureOgreNext::getUsageFlags() const
        {
            return m_usageFlags;
        }

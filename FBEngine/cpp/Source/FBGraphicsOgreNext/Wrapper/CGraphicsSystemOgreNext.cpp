...
namespace fb
{
    namespace render
    {
        ...
        CGraphicsSystemOgreNext::CGraphicsSystemOgreNext() :
            m_root( nullptr ),
            m_resourceLoadingListener( nullptr )
        {
        }
...
#    pragma error "Unsupported platform!"
        ...
        void CGraphicsSystemOgreNext::setRenderSystemDefaults( Ogre::RenderSystem *renderSystem )
        {
            ...
            renderSystem->setConfigOption(
                "Video Mode", Ogre::StringConverter::toString( resolution.X() ) + Ogre::String( " x " ) +
                                  Ogre::StringConverter::toString( resolution.Y() ) +
                                  " @ 32-bit colour" );
        ...
        bool CGraphicsSystemOgreNext::configure( SmartPtr<IGraphicsSettings> config )
        {
            RecursiveMutex::ScopedLock lock( m_mutex );
        ...
        SmartPtr<IWindow> CGraphicsSystemOgreNext::initialise( bool autoCreateWindow,
...
#    endif
        ...
        SmartPtr<IGraphicsScene> CGraphicsSystemOgreNext::addGraphicsScene( const String &type,
                                                                            const String &name )
        {
        ...
        SmartPtr<IGraphicsScene> CGraphicsSystemOgreNext::getGraphicsScene( const String &name ) const
        {
            for( auto sceneManager : m_sceneManagers )
            {
        ...
        SmartPtr<IGraphicsScene> CGraphicsSystemOgreNext::getGraphicsScene() const
        {
            return m_sceneManager;
        }

        SmartPtr<IGraphicsScene> CGraphicsSystemOgreNext::getGraphicsSceneById( hash32 id ) const
        {
            for( auto sceneManager : m_sceneManagers )
            {
        ...
        SmartPtr<IOverlayManager> CGraphicsSystemOgreNext::getOverlayManager() const
        {
            return m_overlayMgr;
        }
        ...
        void CGraphicsSystemOgreNext::setCompositorManager(
            SmartPtr<CompositorManager> compositorManager )
        {
            m_compositorManager = compositorManager;
        }
        ...
        SmartPtr<IWindow> CGraphicsSystemOgreNext::createRenderWindow(
        ...
        SmartPtr<IWindow> CGraphicsSystemOgreNext::getRenderWindow( const String &name ) const
        {
            for( auto window : m_windows )
            {
                auto windowHandle = window->getHandle();
        ...
        SmartPtr<ITextureManager> CGraphicsSystemOgreNext::getTextureManager() const
        {
        ...
        bool CGraphicsSystemOgreNext::isDeferredShadingSystemEnabled() const
        {
            return false;
        }
        ...
        SmartPtr<IDeferredShadingSystem> CGraphicsSystemOgreNext::addDeferredShadingSystem(
        ...
        SmartPtr<IWindow> CGraphicsSystemOgreNext::getDefaultWindow() const
        {
...
#    endif
        ...
        Array<SmartPtr<IDeferredShadingSystem>> CGraphicsSystemOgreNext::getDeferredShadingSystems()
            const
        {
            return m_deferredShadingSystems;
        }

        SmartPtr<ISpriteRenderer> CGraphicsSystemOgreNext::getSpriteRenderer() const
        {
            return nullptr;
        }
        ...
        SmartPtr<IGraphicsSettings> CGraphicsSystemOgreNext::createConfiguration()
        {
            auto applicationManager = core::IApplicationManager::instance();
            FB_ASSERT( applicationManager );
        ...
        SmartPtr<IDebug> CGraphicsSystemOgreNext::getDebug() const
        {
            return m_debug;
        }
        ...
        void CGraphicsSystemOgreNext::loadObject( SmartPtr<ISharedObject> graphicsObject,
                                                  bool forceQueue )
        {
#if 0
            if( graphicsObject )
        ...
        void CGraphicsSystemOgreNext::unloadObject( SmartPtr<ISharedObject> graphicsObject,
                                                    bool forceQueue )
        {
#if 1
            if( graphicsObject )
        ...
        Thread::Task CGraphicsSystemOgreNext::getStateTask() const
        {
            return Thread::Task::Render;
        }

        Thread::Task CGraphicsSystemOgreNext::getRenderTask() const
        {
            auto applicationManager = core::IApplicationManager::instance();
            FB_ASSERT( applicationManager );
        ...
        Array<SmartPtr<IWindow>> CGraphicsSystemOgreNext::getWindows() const
        {
            return m_windows;
        }
        ...
        bool CGraphicsSystemOgreNext::AppFrameListener::frameRenderingQueued(
        ...
        void CGraphicsSystemOgreNext::createDebugTextOverlay( void )
        {
        ...
        CGraphicsSystemOgreNext::WindowEventListener::~WindowEventListener()
        {
        }

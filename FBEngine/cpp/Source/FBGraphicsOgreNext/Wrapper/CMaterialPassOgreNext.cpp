...
namespace fb
{
    namespace render
    {
        FB_CLASS_REGISTER_DERIVED( fb, CMaterialPassOgreNext, IMaterialPass );
                    ...
                    if( material )
                    {
                        ...
                        if( datablock )
                        {
                            ...
                            case IMaterial::MaterialType::Standard:
                            {
                                ...
                                pDatablock->setEmissive(
                                    Ogre::Vector3( e.r, e.g, e.b ) );  // todo hack for testing
        ...
        SmartPtr<IMaterialTexture> CMaterialPassOgreNext::createTextureUnit()
        {
            auto applicationManager = core::IApplicationManager::instance();
            FB_ASSERT( applicationManager );
        ...
        void CMaterialPassOgreNext::MaterialPassStateListener::handleQuery(
            SmartPtr<IStateQuery> &query )
        {
        }

        CMaterialPassOgreNext *CMaterialPassOgreNext::MaterialPassStateListener::getOwner() const
        {
            return m_owner;
        }
        ...
        Ogre::Pass *CMaterialPassOgreNext::getPass() const
        {
            return m_pass;
        }
        ...
        Ogre::HlmsDatablock *CMaterialPassOgreNext::getDataBlock() const
        {

...
namespace fb
{
    namespace render
    {
        ...
        void COverlayElementText::setAlignment( u8 alignment )
        {
            if( m_elementText )
            {
                m_elementText->setAlignment( (Ogre::v1::TextAreaOverlayElement::Alignment)alignment );
            }
        }
        ...
        u8 COverlayElementText::getAlignment() const
        {
            if( m_elementText )
            {
                return (u8)m_elementText->getAlignment();
            }
        ...
        Ogre::v1::TextAreaOverlayElement *COverlayElementText::getElementText() const
        {

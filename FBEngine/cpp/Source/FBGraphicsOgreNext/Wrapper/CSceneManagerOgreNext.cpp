    ...
    namespace render
    {
            ...
            m_isClearing( false )
        {
            try
            {
                ...
                //m_state->setStateObject( m_stateObject );
        ...
        void CSceneManagerOgreNext::load( SmartPtr<ISharedObject> data )
        {
            try
            {
                ...
                m_sceneManager->setAmbientLight( Ogre::ColourValue::White * 0.1f,
                                                 Ogre::ColourValue::White * 0.01f, Ogre::Vector3::UNIT_Y,
                                                 1.0f );
        ...
        SmartPtr<IStateContext> CSceneManagerOgreNext::getStateObject() const
        {
            return m_stateObject;
        }

        void CSceneManagerOgreNext::setStateObject( SmartPtr<IStateContext> stateObject )
        {
            m_stateObject = stateObject;
        }

        fb::SmartPtr<fb::render::IGraphicsObject> CSceneManagerOgreNext::addGraphicsObjectByTypeId(
            u32 id )
        {
            return nullptr;
        }
        ...
        SmartPtr<IGraphicsMesh> CSceneManagerOgreNext::addMesh( const String &name,
            ...
            try
            {
                ...
                if( meshExtention == engineMeshExtention )
                {
                    ...
                    if( meshResult.second )
                    {
                        ...
                        SmartPtr<CGraphicsMeshOgreNext> graphicsObject(
                            new CGraphicsMeshOgreNext( this ) );
        ...
        SmartPtr<IBillboardSet> CSceneManagerOgreNext::addBillboardSet( const String &name,
                                                                        u32 poolSize )
        {
#ifndef _FINAL_
            validateGfxObjName( name );
            ...
            Ogre::v1::BillboardSet
                *bbSet;  // = m_sceneManager->createBillboardSet(name.c_str(), poolSize);
        ...
        SmartPtr<IParticleSystem> CSceneManagerOgreNext::addParticleSystem(
                                               ...
                                               bool drawFirst )
        {
            try
            {
                ...
                if( loadingState == LoadingState::Loaded && task == renderTask )
                {
                    ...
                    {
                        m_sceneManager->setSky(
                            enable, Ogre::SceneManager::SkyCubemap, "",
                            Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME );
                    }
                }
                else
        ...
        SmartPtr<IInstancedObject> CSceneManagerOgreNext::createInstancedObject(
        ...
        CSceneManagerOgreNext::SceneManagerStateListener::SceneManagerStateListener()
        {
        }
            ...
            if( smgr )
            {
                try
                {
                    ...
                    if( sceneManagerState )
                    {
                        ...
                        smgr->setAmbientLight( ambientLight * 0.5f, ambientLight * 0.1f,
        ...
        void CSceneManagerOgreNext::SceneManagerStateListener::handleQuery(

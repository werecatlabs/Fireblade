...
namespace fb
{
    namespace render
    {
        ...
        FB_CLASS_REGISTER_DERIVED( fb, CLightOgreNext, CLight );
        ...
        CLightOgreNext::CLightOgreNext( SmartPtr<IGraphicsScene> creator ) : m_light( nullptr )
        {
            setCreator( creator );
        ...
        CLightOgreNext::CLightStateListener::CLightStateListener()
        {
        }

        CLightOgreNext::CLightStateListener::CLightStateListener( CLightOgreNext *light ) :
            m_owner( light )
        {
        }
        ...
        CLightOgreNext *CLightOgreNext::CLightStateListener::getOwner() const
        {
            return m_owner;
        }

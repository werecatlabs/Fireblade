...
namespace fb
{
    namespace render
    {
        ...
        SmartPtr<IResource> CTextureManagerOgreNext::load( const String &name )
        {
            try
            {
        ...
        fb::SmartPtr<fb::IStateContext> CTextureManagerOgreNext::getStateObject() const
        {
            return nullptr;
        }

        void CTextureManagerOgreNext::setStateObject( SmartPtr<IStateContext> stateObject )
        {
        }
        ...
        fb::Parameter CTextureManagerOgreNext::TextureListener::handleEvent(

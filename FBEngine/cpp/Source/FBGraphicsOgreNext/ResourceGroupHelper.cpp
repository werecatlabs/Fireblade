                                                                         ...
                                                                         bool &skipMessage )
{
    ...
    //  Ogre::StringUtil::match(message,pattern2,true); if(lErrorfound)
    //  {
...
// Ogre::Renderable::Visitor& pVisitor, bool debugRenderable)
//{
//    // call on 'this'
...
//       pOverlayContainer->getChildContainerIterator(); for(;childContainerIter.hasMoreElements();)
//       {

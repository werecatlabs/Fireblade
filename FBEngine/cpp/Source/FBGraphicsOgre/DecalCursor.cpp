...
namespace fb
{
    namespace render
    {
        ...
        void DecalCursor::init( const Ogre::Vector2 &size, const std::string &tex )
        {
            ...
            /* Commented out for general use. If you are using mouse picking in your scene, set this to
             * an unselectable flag otherwise you may find the frustum in your ray queries. */
            ...
            Ogre::TextureManager::getSingleton().load(
                m_sTextureName, Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME,
                Ogre::TEX_TYPE_2D, 1 );

...
#include "FBGraphicsOgre/Ogre/DynamicRenderable.h"
...
void DynamicRenderable::initialise( RenderOperation::OperationType operationType, bool useIndices )
{
    ...
    if( mRenderOp.useIndexes )
    {
        ...
        if( newIndexCapacity != mIndexBufferCapacity )
        {
            ...
            else
            {
                ...
                mRenderOp.indexData->indexBuffer =
                    HardwareBufferManager::getSingleton().createIndexBuffer(
                        HardwareIndexBuffer::IT_32BIT, mIndexBufferCapacity,
                        HardwareBuffer::HBU_DYNAMIC_WRITE_ONLY );  // TODO: Custom HBU_?
            }
        }

...
namespace fb
{
    namespace scene
    {
        ...
        SmartPtr<Properties> WheelController::getProperties() const
        {
        ...
        Array<SmartPtr<ISharedObject>> WheelController::getChildObjects() const
        {
            auto objects = Array<SmartPtr<ISharedObject>>();
            objects.reserve( 5 );

            objects.push_back( m_wheelController );

            return objects;
        }

        SmartPtr<IWheelController> WheelController::getWheelController() const
        {
        ...
        f32 WheelController::getMassFraction() const
        {
        ...
        f32 WheelController::getRadius() const
        {
            return m_radius;
        }
        ...
        f32 WheelController::getWheelDamping() const
        {
        ...
        f32 WheelController::getSuspensionDistance() const
        {

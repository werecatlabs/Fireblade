...
namespace fb
{
    namespace core
    {
        FB_CLASS_REGISTER_DERIVED( fb, ApplicationManagerMT, CSharedObject<IApplicationManager> );

        ApplicationManagerMT::ApplicationManagerMT() : CSharedObject<IApplicationManager>()
        {
        }

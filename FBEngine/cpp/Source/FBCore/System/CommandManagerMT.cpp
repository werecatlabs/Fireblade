...
namespace fb
{
    ...
    void CommandManagerMT::addListener( SmartPtr<ICommandManagerListener> listener )
    {
        m_listeners.push_back( listener );
    }

    bool CommandManagerMT::removeListener( SmartPtr<ICommandManagerListener> listener )
    {

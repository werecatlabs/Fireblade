...
namespace fb
{
    FB_CLASS_REGISTER_DERIVED( fb, ScaleManipulator, Manipulator );
    ...
    auto ScaleManipulator::handleEvent( const SmartPtr<IInputEvent> &event ) -> bool
    {
        ...
        if( mouseState )
        {
            ...
            {
                FB_LOG_MESSAGE( "ScaleManipulator", "ScaleManipulator: MouseButtonUp" );
            ...
            {
                FB_LOG_MESSAGE( "ScaleManipulator", "CTranslateGizmo: MouseButtonDown" );
            ...
            {
                FB_LOG_MESSAGE( "ScaleManipulator", "CTranslateGizmo: EMIE_MOUSE_MOVED" );
                ...
                if( m_selected[0] || m_selected[1] || m_selected[2] )
                {
                    ...
                    for( auto selected : selection )
                    {
                        ...
                        if( actor )
                        {
                            ...
                            {
                                auto entityPos = transform->getLocalScale();
                                ...
                                if( diff > Math<real_Num>::epsilon() )
                                {
                                    ...
                                    transform->setLocalScale( localPosition );

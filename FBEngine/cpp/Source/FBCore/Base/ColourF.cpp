...
namespace fb
{
    ...
    ColourF ColourF::getInterpolated_quadratic( const ColourF &c1, const ColourF &c2, const f32 d ) const
    {
        ...
        return ColourF( r * mul0 + c1.r * mul1 + c2.r * mul2, g * mul0 + c1.g * mul1 + c2.g * mul2,
                        g * mul0 + c1.b * mul1 + c2.b * mul2, a * mul0 + c1.a * mul1 + c2.a * mul2 );
    }

    ColourF ColourF::getInterpolated( const ColourF &other, f32 d ) const
    {
        const auto inv = 1.0f - d;
        return ColourF( other.r * inv + r * d, other.g * inv + g * d, other.b * inv + b * d,
                        other.a * inv + a * d );
    }
    ...
    ColourI ColourF::toSColor() const
    {
        return ColourI( static_cast<u32>( static_cast<f32>( a ) * 255.0f ),
    ...
    ColourF ColourF::operator*( const f32 fScalar ) const
    {
        ColourF kProd;
    ...
    ColourF &ColourF::operator*=( const f32 fScalar )
    {
        r *= fScalar;
        g *= fScalar;
        b *= fScalar;
    ...
    bool ColourF::operator==( const ColourF &other ) const
    {

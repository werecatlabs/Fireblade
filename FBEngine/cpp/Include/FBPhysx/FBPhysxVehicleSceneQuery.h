#ifndef FBPhysxVehicleSceneQuery_h__
#define FBPhysxVehicleSceneQuery_h__
    ...
    PxSceneQueryFilterFlags &filterFlags )
{
    ...
    return ( ( 0 == ( filterData1.word3 & SAMPLEVEHICLE_DRIVABLE_SURFACE ) )
                 ? PxSceneQueryHitType::eNONE
                 : PxSceneQueryHitType::eBLOCK );
}
...
public:
    ...
    static SampleVehicleSceneQueryData *allocate( PxU32 maxNumWheels );
    ...
    void setSpuPreFilterShader( void *spuPreFilterShader, const PxU32 spuPreFilterShaderSize )
    {
        mSpuPreFilterShader = spuPreFilterShader;
        mSpuPreFilterShaderSize = spuPreFilterShaderSize;
    }
...
#endif // FBPhysxVehicleSceneQuery_h__

...
namespace fb
{
    ...
    template <typename Container, typename Value>
    std::pair<typename Container::key_type, Value>
        *ConcurrentHashmapIterator<Container, Value>::operator->()
    {
        return &m_value;
    }

    template <typename Container, typename Value>
    const std::pair<typename Container::key_type, Value>
        *ConcurrentHashmapIterator<Container, Value>::operator->() const
    {
        return &m_value;
    }
    ...
    template <typename Container, typename Value>
    ConcurrentHashmapIterator<Container, Value>::ConcurrentHashmapIterator(
        const ConcurrentHashmapIterator &other ) :

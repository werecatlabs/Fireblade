...
#include <FBCore/Math/Core/RaycastHit.h>
...
namespace fb
{
    namespace physics
    {
        ...
        public:
             ...
             */
            virtual bool rayTest( const Vector3F &start, const Vector3F &direction, Vector3F &hitPos,
             ...
             * @return True if there was an intersection, false otherwise.
             */
            virtual bool intersects( const Vector3F &start, const Vector3F &end, Vector3F &hitPos,

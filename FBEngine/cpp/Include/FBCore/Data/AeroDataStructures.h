namespace fb
{
    namespace data
    {
        ...
        {
            FB_CONSTRUCTOR( aircraft_wing_data() {
        ...
        {
            FB_CONSTRUCTOR( aircraft_engine_data() {
        ...
        {
            FB_CONSTRUCTOR( aircraft_control_surface_data() {
        ...
        {
            FB_CONSTRUCTOR( aircraft_prop_wash_data() {
                propwashSource = "";
                strength = 0.01f;
                maxSpeed = static_cast<float>( 1e10 );
            } )
        ...
        {
            FB_CONSTRUCTOR( aircraft_ground_effect_data() {
        ...
        {
            FB_CONSTRUCTOR( aircraft_cog_data(){} )
        ...
        FB_STRUCT_INHERIT( aircraft_wheel_data, public aircraft_attachment_data )
        {
            FB_CONSTRUCTOR( aircraft_wheel_data() {
                mass = 1.0f;
                radius = 0.02f;
                wheelDamping = 0.25f;
        ...
        FB_STRUCT_INHERIT( aircraft_data, public base_data )
        {
            FB_CONSTRUCTOR( aircraft_data() {

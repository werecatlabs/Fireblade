...
namespace fb
{
    namespace scene
    {
        ...
        class BaseComponent : public CResource<IComponent>
        {
        public:
            ...
            public:
                ...
                BaseComponent *getOwner() const;

                /** Set the owner of the listener. */
                void setOwner( BaseComponent *owner );
...
#include <FBCore/Scene/Components/BaseComponent.inl>

...
namespace fb
{
    namespace scene
    {
        ...
        template <class T>
        class Component : public CResource<T>
        {
        public:
        ...
        template <class T>
        SmartPtr<Properties> Component<T>::getProperties() const
        {
            return nullptr;
        }

        template <class T>
        SmartPtr<IStateContext> Component<T>::getStateObject() const
        {
            return nullptr;
        }

        template <class T>
        SmartPtr<scene::IActor> Component<T>::getActor() const
        {
            return nullptr;
        }

        template <class T>
        IComponent::State Component<T>::getState() const
        {
...
#include <FBCore/Scene/Components/Component.inl>

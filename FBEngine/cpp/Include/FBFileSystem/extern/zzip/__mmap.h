...
#    define _zzip_mmap( user, fd, offs, len ) mmap( 0, len, PROT_READ, MAP_SHARED, fd, offs )
#    define _zzip_munmap( user, ptr, len ) munmap( ptr, len )
...
#    define _zzip_mmap( user, fd, offs, len ) win32_mmap( (long *)&( user ), fd, offs, len )
#    define _zzip_munmap( user, ptr, len ) win32_munmap( (long *)&( user ), ptr, len )

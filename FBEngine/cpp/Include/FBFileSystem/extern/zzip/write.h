...
ZZIP_DIR *zzip_dir_creat_ext_io( zzip_char_t *name, int o_mode, zzip_strings_t *ext,
                                 zzip_plugin_io_t io );
...
#    define zzip_mkdir( _name_, _mode_ ) zzip_file_mkdir( ( zzip_savefile ), ( _name_ ), ( _mode_ ) )
#    define zzip_creat( _name_, _mode_ ) zzip_file_creat( ( zzip_savefile ), ( _name_ ), ( _mode_ ) )
#    define zzip_sync() \
        { \

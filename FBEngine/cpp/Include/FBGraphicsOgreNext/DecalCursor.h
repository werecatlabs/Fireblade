...
{
public:
    DecalCursor( Ogre::SceneManager *man, Ogre::MaterialPtr terrainMat, const Ogre::Vector2 &size,
    ...
    void setTextureName( const std::string &val );
...
private:
    ...
    std::string m_sTextureName; /**< @brief texture to apply */

...
class DynamicRenderable : public Ogre::v1::SimpleRenderable
{
public:
    /// Constructor
    DynamicRenderable();
    ...
    /// Constructor
    DynamicRenderable( const DynamicRenderable &other ) = delete;
    /// Virtual destructor
    ...
    void initialise( Ogre::OperationType operationType, bool useIndices );
...
protected:
    ...
    are large enough to hold getHeight least the requested number of

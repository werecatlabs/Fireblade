...
{
public:
    DeferredLightRenderOperation( DeferredShadingSystem *system, Ogre::CompositorInstance *instance,
...
{
public:
    DeferredLightCompositionPass( DeferredShadingSystem *system, Ogre::SceneManager *smgr );

...
public:
    ...
    mImpl field.
*/
    MaterialGenerator( DeferredShadingSystem *system );
...
protected:
    ...
    typedef fb::HashMap<Perm, Ogre::GpuProgramPtr> ProgramMap;
    typedef fb::HashMap<Perm, Ogre::MaterialPtr> MaterialMap;

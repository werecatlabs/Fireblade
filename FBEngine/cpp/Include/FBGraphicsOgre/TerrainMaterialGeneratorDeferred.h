...
namespace Ogre
{
    ...
    */
    class TerrainMaterialGeneratorDeferred : public TerrainMaterialGenerator
    {
    public:
        TerrainMaterialGeneratorDeferred();
        ~TerrainMaterialGeneratorDeferred();
        ...
        protected:
            ...
            protected:
                ...
                virtual void generateFpHeader( const SM2Profile *prof, const Terrain *terrain,
                                               TechniqueType tt,
                                               StringUtil::StrStreamType &outStream ) = 0;
    ...
    typedef Ogre::SharedPtr<TerrainMaterialGeneratorDeferred> TerrainMaterialGeneratorDeferredPtr;

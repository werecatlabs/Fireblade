...
namespace Forests
{
    ...
    public:
        ...
        bool injectImpostorBatch( const Ogre::String &key, ImpostorBatch *injectedBatch )
        {
            return injectedBatch
                       ? m_mapImpostorBatches.insert( TImpostorBatchs::value_type( key, injectedBatch ) )
                             .second
                       : false;
        }
        ...
        */
        ...
        {
            s_nImpostorResolution = pixels;
        }
        static Ogre::uint getImpostorResolution()
        {
            return s_nImpostorResolution;
        }
        ...
        */
        ...
        {
            return s_clrImpostorBackground;
        }
    ...
    protected:
        ...
        void
        updateMaterials();  // Updates the materials to use the latest rendered impostor texture grid
    ...
    inline void ImpostorBatch::addBillboard( const Ogre::Vector3 &position,

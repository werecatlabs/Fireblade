...
namespace Forests
{
    ...
    */
    ...
    public:
        ...
        void addTree( Ogre::Entity *entity, const Ogre::Vector3 &position,
                      Ogre::Degree yaw = Ogre::Degree( 0 ), Ogre::Real scale = 1.0f,
                      void *userData = NULL );
...
will be deleted. */
        ...
        void
#endif
        deleteTrees( const Ogre::Vector3 &position, Ogre::Real radius = 0.001f,
...
will be deleted. */
        ...
        /** \brief Find trees within a certain radius of the given coordinates.
            ...
            \note If the "type" parameter is set to an entity, only trees created with that entity
            will be found. */
        std::vector<void *> findTrees( const Ogre::Vector3 &position, float radius,
                                       Ogre::Entity *type = NULL );
#endif
    ...
    private:
        ...
        Ogre::Real ( *heightFunction )( Ogre::Real x, Ogre::Real z,
                                        void *userData );  //Pointer to height function
        ...
        inline void _setGridPage( std::vector<TreeDef> *grid, int x, int z,
                                  const std::vector<TreeDef> &page )
        {
#ifdef _DEBUG
            if( x >= pageGridX || z >= pageGridZ )
                OGRE_EXCEPT( Ogre::Exception::ERR_INVALIDPARAMS, "Grid dimension is out of bounds",

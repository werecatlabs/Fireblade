...
namespace Forests
{
    ...
    public:
        ...
        protected:
            ...
            struct QueuedMesh
            {
                QueuedMesh( Ogre::SubMesh *sm, const Ogre::Vector3 &pos, const Ogre::Quaternion &ori,
                            const Ogre::Vector3 &scl, const Ogre::ColourValue &clr,
                            void *userData_ = 0 ) :
                    subMesh( sm ),
                    position( pos ),
                    orientation( ori ),
        ...
        public:
            ...
            void setMaterialName(
                ...
                const Ogre::String &rg = Ogre::ResourceGroupManager::AUTODETECT_RESOURCE_GROUP_NAME )
            {
            ...
            {
                return m_ptrMaterial->getName();
            }
            Ogre::Technique *getTechnique() const
            {
                return m_pBestTechnique;
            }
            ...
            {
                return m_pParentGeom->m_pSceneNode->_getDerivedPosition();
            }
            bool castsShadows( void ) const
            {
                return m_pParentGeom->getCastShadows();
            }
        ...
        private:
            ...
            static void _buildFullTransform(
                const QueuedMesh &queuedMesh, const Ogre::Vector3 &parentGeomCenter,
                const std::vector<Ogre::VertexDeclaration::VertexElementList> &vertexBufferElements,
                std::vector<Ogre::uchar *> &vertexBuffers, Ogre::VertexData *dst );
    ...
    public:
        ...
        {
            return TConstSubBatchIterator( m_mapSubBatch );
        }
        TSubBatchIterator getSubBatchIterator()
        {
            return TSubBatchIterator( m_mapSubBatch );
        }

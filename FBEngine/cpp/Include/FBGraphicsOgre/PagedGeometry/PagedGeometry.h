...
#    endif
        ...
        */
        void setCustomParam( const Ogre::String &entity, const Ogre::String &paramName,
                             float paramValue );
        ...
        */
        float getCustomParam( const Ogre::String &entity, const Ogre::String &paramName,
    ...
    protected:
        //Internal function - do not use
        void _addDetailLevel( GeometryPageManager *mgr, Ogre::Real maxRange,
        ...
        bool
            geometryAllowedVisible;  //If set to false, all geometry managed by this PagedGeometry is hidden
...
#    endif
    ...
    */
    ...
    public:
        ...
        */
        virtual void setFade( bool enabled, Ogre::Real visibleDist = 0,
                              Ogre::Real invisibleDist = 0 ) = 0;
    ...
    private:
        ...
        unsigned long
            _inactiveTime;  //How long this page has been inactive (used to calculate expired pages)
    ...
    */
    ...
    public:
        ...
        */
        inline void setCacheSpeed( unsigned long maxCacheInterval = 200,
        ...
        /** \brief Internal function - DO NOT USE */
        template <class PageType>
        void initPages( const TBounds &bounds, const Ogre::Any &data = Ogre::Any(),
                        Ogre::uint32 queryFlag = 0 );

        /** \brief Internal function - DO NOT USE */
        void update( unsigned long deltaTime, Ogre::Vector3 &camPos, Ogre::Vector3 &camSpeed,
    ...
    private:
        ...
        GeometryPage **
            scrollBuffer;  //A dynamic 1D array of pointers (temporary GeometryPage's used in scrolling geomGrid)
...
#    endif
    ...
    template <class PageType>
    inline void GeometryPageManager::initPages( const TBounds &bounds, const Ogre::Any &data,
                                                Ogre::uint32 queryFlag )
    {
        ...
        if( bounds.width() < 0.00001 )
        {
            ...
            geomGridX = (int)( 2.0f * farTransDist / mainGeom->getPageSize() ) + 4;
            gridBounds.top = 0;
            gridBounds.left = 0;
        ...
        else
        {
            ...
            geomGridX = (int)std::ceil( gridBounds.width() / mainGeom->getPageSize() );
        }
        ...
        int xioffset = (int)Ogre::Math::Floor( gridBounds.left / mainGeom->getPageSize() );
        int zioffset = (int)Ogre::Math::Floor( gridBounds.top / mainGeom->getPageSize() );
